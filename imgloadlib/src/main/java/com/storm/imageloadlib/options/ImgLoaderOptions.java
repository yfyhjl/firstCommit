...
public class ImgLoaderOptions {
    ...
    private final BitmapTransformation transform; //位图转换
    ...
    private final Transformation<Bitmap> bitmapTransform;
    ...
    private ImgLoaderOptions(Builder builder) {
        ...
        this.bitmapTransform = builder.bitmapTransform;
    }

    public Transformation<Bitmap> bitmapTransform() {
    ...
    public static class Builder {
        ...
        public Builder bitmapTransform(Transformation<Bitmap> bitmapTransform) {
