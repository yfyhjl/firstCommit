...
public class ImgTarget<Z> extends ImageViewTarget<Z> {
	...
	private void initImagViewTarget(ImageView view) {
		...
		if (mImageView.getVisibility() == View.VISIBLE) {
			isGoneInit = false;
			Log.i(TAG, "initImagViewTarget: VISIBLE");
		} else {
			isGoneInit = true;
			Log.i(TAG, "initImagViewTarget: GONE INVISIBLE");
		}
	}
	...
	public void onLoadStarted(@Nullable Drawable placeholder) {
		...
		Log.i(TAG, "ImgTarget onLoadStarted placeholder:" + placeholder);
	...
	public void onResourceReady(Z resource, @Nullable Transition<? super Z> transition) {
		...
		Log.i(TAG, "ImgTarget onResourceReady resource:" + resource);
		isLoadComplete = true;
		setImageDrawable(resource);
		if (isGoneInit) {
	...
	public void onLoadFailed(@Nullable Drawable errorDrawable) {
		...
		Log.i(TAG, "ImgTarget onLoadFailed errorDrawable:" + errorDrawable);
		isLoadComplete = true;
		if (isGoneInit) {
			mImageView.setVisibility(visibleInit);
		}
	...
	public void onLoadCleared(@Nullable Drawable placeholder) {
		...
		// 加载任务取消并且资源被释放时调用
		Log.i(TAG, "ImgTarget onLoadCleared");
		if (!isLoadComplete) {
			isLoadComplete = true;
			if (mImgLoaderListener != null) {
				Log.i(TAG, "ImgTarget onLoadCleared onLoadCancelled");
