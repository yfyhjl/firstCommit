...
package com.storm.imageload.utils;
...
import com.storm.imageloadlib.ImgLoader;
import com.storm.imageloadlib.options.ImgLoaderOptions;
import com.storm.imageloadlib.listener.ImgLoaderListener;
import com.storm.imageloadlib.listener.ListViewPauseOnScrollListener;
import com.storm.imageloadlib.listener.RecyclerViewPauseOnScrollListener;
import com.storm.imageloadlib.transform.GlideCircleTransform;
import com.storm.imageloadlib.transform.GlideRotateTransformation;
import com.storm.imageloadlib.transform.GlideRoundTransform;
...
public class ImgLoadUtil {
	...
	public static <T> void showImage(T url, ImageView imageView) {
		ImgLoader.getInstance().showImage(url, imageView, null);
	}
	...
	public static <T> void showImage(T url, ImageView imageView, ImgLoaderOptions options) {
		ImgLoader.getInstance().showImage(url, imageView, options);
	}
