...
public class GlideBaseFragment extends Fragment {
	...
	private void initData() {
		...
		Log.i("zony", "GlideBaseFragment getCacheFile :" + ImgLoadUtil.getCacheFile(getActivity(), path));
	...
	private void changeImage(Object path, final ImageView imageView, ImgLoaderOptions options) {
		...
		ImgLoadUtil.showImage(path, imageView, options, new ImgLoaderListener() {
			...
			public void onRequestSuccess(Object resource) {
				Log.i("zony", "GlideBaseFragment onRequestSuccess");
			}

			@Override
			public void onRequestFailed(Exception e) {
				Log.i("zony", "GlideBaseFragment onRequestFailed");
			}

			@Override
			public void onLoadStarted() {
				Log.i("zony", "GlideBaseFragment onLoadStarted");
			}

			@Override
			public void onLoadFailed(Object resource) {
				Log.i("zony", "GlideBaseFragment onLoadFailed");
			}

			@Override
			public void onLoadSuccess(Object resource) {
				Log.i("zony", "GlideBaseFragment onLoadSuccess");
			}

			@Override
			public void onLoadCancelled(Object resource) {
				Log.i("zony", "GlideBaseFragment onLoadCancelled");
			}
		});
	}
